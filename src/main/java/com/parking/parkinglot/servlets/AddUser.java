...
public class AddUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!request.isUserInRole("WRITE_USERS")) {
            response.sendError(HttpServletResponse.SC_FORBIDDEN, "Nu aveți permisiunea de a accesa această pagină.");
            return;
        }
    }
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!request.isUserInRole("WRITE_USERS")) {
            response.sendError(HttpServletResponse.SC_FORBIDDEN, "Nu aveți permisiunea de a efectua această acțiune.");
            return;
        }
    }
}
